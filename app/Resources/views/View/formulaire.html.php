              ...
              <div class="register">
                <form method="POST" action="login" id="contact_form" class="form">                  
                  <div class="form__field">
                    ...
                    <input class="form-control" style="width:50%;margin-right:auto;margin-left:auto"  type="text" name="_pseudo" required="required">
                  </div>
                  
                  <div class="form__field">
                    <label for="password">Mot de passe</label>
                    <input class="form-control" style="width:50%;margin-right:auto;margin-left:auto" type="password" name="_password" required="required" placeholder="••••••••••••">
                  </div>

                  <div class="form__field">
                    <input name="login" id="submitForm" class="myButt one" type="submit" value="Se connecter" style="font-size:13px;margin-top:15px;margin-left:auto;margin-right:auto;float:none;">
                  </div>

                </form>

                <p style="margin-top:20px;">Vous n'avez pas de compte ? <a href="/web/register">Inscrivez-vous !</a></p>
