<?php
  ...
  */
      ...
      $stmt->execute();  
      echo'
      <div style="background-color: #dddddd;border: 1px ridge black;padding:10px;margin-left:20px;margin-bottom:10px;width:80%;overflow:hidden;" class="callout" data-closable="">
        <div style="border-bottom: solid 1px;">
          <img style="width:30px;height:30px;" src="met.jpg">
            <span style="margin-left:10px;">'.$pseudoNostreamer.'<small> le 2017-03-23 13:10:29</small></span>
              <input name="idComment" value="132" hidden="">
